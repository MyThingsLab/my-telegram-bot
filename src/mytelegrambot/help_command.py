...
_HELP_TEXT = "\n".join(
    [
        ...
        "  /note <text>",
        "      Capture a freeform note as a my-notes issue. It comes back",
        "      tagged and titled.",
        "  /catalog",
        "      See everything the fleet can do, explained in plain language.",
        "      Tap a tool to see exactly what it would do — a dry run.",
        "  /wish <text>",
        "      Say what you want in your own words. I'll point you at the",
        "      tools that serve it, or tell you the fleet can't.",
        "  /status",
