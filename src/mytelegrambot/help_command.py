...
_HELP_TEXT = "\n".join(
    [
        ...
        "",
        "*/halt* · */resume* — operator only",
        "Stop the fleet from launching any further work, and let it start again.",
        "The kill switch, reachable without a terminal.",
        "",
        "*/prs* — operator only",
        "List open PRs that are currently green and mergeable, each with an",
        "Approve & merge button. Tapping one only records your approval here — a",
        "human still merges, through my-fleet's own Guard-gated merge step.",
        "",
        "*/help*",
        "Show this message.",
        "",
